...
from tgbot.misc.staff_actions import show_orders_message, show_item, staff_action
...
async def change_order_ready(callback_query: CallbackQuery, callback_data: dict):
    ...
    return await staff_action(callback_query, callback_data, {'is_ready': callback_data['value']},
                              'Статус приготування змінено!', 'Помилка при зміні статусу приготування!',
