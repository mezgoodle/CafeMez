...
urlpatterns = [
    ...
    path('categories', views.CategoryList.as_view(), name='get_categories'),
    path('category', views.CategoryDetail.as_view(), name='get_category'),
    path('subcategories/<str:category_code>', views.SubCategoryList.as_view(), name='get_subcategories'),
